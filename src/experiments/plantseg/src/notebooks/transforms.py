...
class RandomFlip:
    ...
    def __call__(self, m):
        if np.max(m) > 100:
            np.save('/scratch/ottosson/investigation/plantseg/src/notebooks/label_batch.npy', m)
        else:
            np.save('/scratch/ottosson/investigation/plantseg/src/notebooks/raw_batch.npy', m)
